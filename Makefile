...
${TRGDIR}/test_arytm_zesp: ${OBJ} ${OBJ}/main.o ${OBJ}/LZespolona.o ${OBJ}/Statystyka.o\
                     ${OBJ}/WyrazenieZesp.o ${OBJ}/BazaTestu.o ${OBJ}/Statystyka.o ${OBJ}/BazaTestu.o 
...
${OBJ}/Statystyka.o: src/Statystyka.cpp inc/Statystyka.hh inc/WyrazenieZesp.hh\
                       inc/LZespolona.hh inc/BazaTestu.hh
